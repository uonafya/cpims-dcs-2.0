...
from .models import (
    SIPopulation, SystemUsage, CCIPopulation, COPIPs)
...
@admin.register(COPIPs)
class COPIPsAdmin(admin.ModelAdmin):

    list_display = ('cop', 'cop_target', 'funding', 'ip', 'timestamp_created')
    list_per_page = 10

    list_filter = ('cop', 'is_void')
