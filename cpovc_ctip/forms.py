...
class CTIPFormB(forms.Form):
    ...
    qfB1_txt = forms.CharField(widget=forms.Textarea(
    ...
    qfB2_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Note'),
               'class': 'form-control',
               'id': 'qfB2_txt',
               'rows': '3'}))
    ...
    qfB3_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Note'),
               'class': 'form-control',
               'id': 'qfB3_txt',
               'rows': '3'}))
    ...
    qfB4_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Note'),
               'class': 'form-control',
               'id': 'qfB4_txt',
               'rows': '3'}))
...
class CTIPFormD(forms.Form):
    ...
    qfDR1_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR1_txt'}))

    qfDR2_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR2_txt'}))

    qfDR3_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR3_txt'}))

    qfDR4_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR4_txt'}))

    qfDR5_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR5_txt'}))

    qfDR6_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR6_txt'}))

    qfDR7_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR7_txt'}))

    qfDR8_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR8_txt'}))

    qfDR9_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR9_txt'}))

    qfDR10_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR10_txt'}))

    qfDR11_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR11_txt'}))

    qfDR12_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR12_txt'}))

    qfDR13_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR13_txt'}))

    qfDR14_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDR14_txt'}))
    ...
    qfDC2_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC2_txt'}))

    qfDC3_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC3_txt'}))

    qfDC4_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC4_txt'}))

    qfDC5_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC5_txt'}))

    qfDC6_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC6_txt'}))

    qfDC7_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC7_txt'}))

    qfDC8_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC8_txt'}))

    qfDC9_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC9_txt'}))

    qfDC10_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC10_txt'}))

    qfDC11_txt = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'form-control',
               'id': 'qfDC11_txt'}))

    qfDC12_txt = forms.CharField(widget=forms.Textarea(
    ...
    qfD11_txt = forms.CharField(widget=forms.Textarea(
    ...
    qfD21_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Other details'),
               'class': 'form-control',
               'id': 'qfD21_txt',
               'rows': '3'}))
    ...
    qfD32_txt = forms.CharField(widget=forms.TextInput(
    ...
    qfD41_txt = forms.CharField(widget=forms.TextInput(
        attrs={'placeholder': _('Specify'),
               'class': 'form-control'
               }))

    qfD42_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Other benefits'),
               'class': 'form-control',
               'id': 'qfD31_txt',
               'rows': '3'}))

    qfD50_txt = forms.DateField(widget=forms.TextInput(
    ...
    qfD102_txt = forms.CharField(widget=forms.Textarea(
    ...
    qfD131_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Other'),
               'class': 'form-control',
               'id': 'qfD131_txt',
               'rows': '3'}))

    qfD140_txt = forms.CharField(widget=forms.TextInput(
        attrs={'placeholder': _('How soon'),
               'class': 'form-control',
               'id': 'qfD140_txt',
               }))

    qfD141_txt = forms.CharField(widget=forms.TextInput(
    ...
    qfD143_txt = forms.CharField(widget=forms.TextInput(
    ...
    qfD190H_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Details'),
               'class': 'form-control',
               'id': 'qfD190H_txt',
               'rows': '2'}))
    ...
    qfD232_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Other'),
               'class': 'form-control',
               'id': 'qfD232_txt',
               'rows': '3'}))
    ...
    qfD250_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Other'),
               'class': 'form-control',
               'id': 'qfD250_txt',
               'rows': '3'}))
...
class CTIPFormE(forms.Form):
    ...
    qfE2b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE2b_txt',
               'rows': '3'}))
    ...
    qfE3b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE3b_txt',
               'rows': '3'}))
    ...
    qfE4b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE4b_txt',
               'rows': '3'}))
    ...
    qfE5b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE5b_txt',
               'rows': '3'}))
    ...
    qfE6b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE6b_txt',
               'rows': '3'}))
    ...
    qfE7b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE7b_txt',
               'rows': '3'}))
    ...
    qfE8b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE8b_txt',
               'rows': '3'}))
    ...
    qfE9b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE9b_txt',
               'rows': '3'}))
    ...
    qfE10b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE10b_txt',
               'rows': '3'}))
    ...
    qfE11b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE11b_txt',
               'rows': '3'}))
    ...
    qfE12b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE12b_txt',
               'rows': '3'}))
    ...
    qfE13b_txt = forms.CharField(widget=forms.Textarea(
        attrs={'placeholder': _('Intervention'),
               'class': 'form-control',
               'id': 'qfE13b_txt',
               'rows': '3'}))
